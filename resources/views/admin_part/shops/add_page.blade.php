...
@section('info_container')
    <div class="admin_part_info_container" style="min-height: 300px; padding: 1.5rem">
        ...
        <form action="{{ route('store_shop') }}" method="POST" enctype="multipart/form-data" class="row">
            @csrf
            <div class="col-lg-9">
                ...
                <div class="tab_content" id="anounce">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" id="example-fileinput" class="form-control" name="default_file_input[]"
                            multiple>
                    </div>
