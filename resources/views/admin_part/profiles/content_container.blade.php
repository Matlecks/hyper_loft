            ...
            <table class="table table-hover">
                <thead>
                    <tr style="background: #EEF2F7FF;">
                        ...
                        <th scope="col">
                            <form action="{{-- {{ route('sort_shop_table') }} --}}" method="POST" class="d-flex justify-content-between"
                ...
                @include('admin_part.profiles.profiles_table')
            </table>
        </div>
    </div>
